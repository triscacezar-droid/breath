...
/** BPM → strip position (vertical). Very slow <1.5, Slow 1.5–3, Calming 3–8, Normal 8–16, Fast 16+ */
function bpmToPosition(bpm: number): number {
  ...
  if (bpm <= 16) return 21 + ZONE_GAP + 14 + ZONE_GAP + 19 + ZONE_GAP + ((bpm - 8) / 8) * 21
  return 21 + ZONE_GAP + 14 + ZONE_GAP + 19 + ZONE_GAP + 21 + ZONE_GAP + Math.min((bpm - 16) / 4, 1) * 13
}
